...
public enum MessageErrorCode implements ErrorCode {
    No_EXIST_MESSAGE(HttpStatus.BAD_REQUEST, "존재하지 않는 메세지 ID입니다"),
    MESSAGE_CANNOT_SEND_TO_SELF(HttpStatus.BAD_REQUEST, "메세지는 자기 자신에게 보낼 수 없습니다."),
    MESSAGE_ONLY_READ_RECEIVER(HttpStatus.BAD_REQUEST, "메세지는 자기 자신만 읽을 수 있습니다."),
    ;
